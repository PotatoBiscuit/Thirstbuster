...
if ($result->num_rows != 0){
	while($row = $result->fetch_assoc()){
		...
		. "<thead class='thead-inverse'><tr id = 'order_rows'><td><b>Table</b></td> <td><b>" . $table_number . "</b></td></tr></thead>\n"
		...
		. "<label onclick='changeOrderStatus(" . $row["id"] . ", 2, \"Ordered\")' for='sc-1-" . $row["id"] . "-1' data-value='Ordered'>Ordered</label>"
		. "<label onclick='changeOrderStatus(" . $row["id"] . ", 2, \"Filling\")' for='sc-1-" . $row["id"] . "-2' data-value='Filling'>Filling</label>"
		. "<label onclick='changeOrderStatus(" . $row["id"] . ", 2, \"Delivering\")' for='sc-1-" . $row["id"] . "-3' data-value='Delivering'>Delivering</label>"
		. "</div>"		
		. "</td></tr>\n"
